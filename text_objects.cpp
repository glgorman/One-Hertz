...
//  It is also called when a

text_object::text_object (text_object &copy)
{
	copy.m_nList.m_refCount++;
	m_nList.m_refCount = copy.m_nList.m_refCount;
